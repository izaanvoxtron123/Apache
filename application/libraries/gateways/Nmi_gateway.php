...
class Nmi_gateway extends App_gateway
{
    ...
    public function process_payment($data)
    {
        ...
        $invoice_details = base64_encode(json_encode($data));
        return redirect('nmi_payment/process_payment/?invoice=' . $invoice_details);
    }
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://hms.transactiongateway.com/api/transact.php");
