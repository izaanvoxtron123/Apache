...
CREATE TABLE `tblclients` (
  ...
  `stripe_payment_method_id` varchar(40) DEFAULT NULL,
...
--
-- Table structure for table `tblleads_images`
--

CREATE TABLE `tblleads_images` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `tblstripe_merchants`
--

CREATE TABLE `tblstripe_merchants` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tblstripe_merchants`
--
ALTER TABLE `tblstripe_merchants`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tblstripe_merchants`
--
ALTER TABLE `tblstripe_merchants`
...
--
-- Indexes for table `tblleads_images`
--
ALTER TABLE `tblleads_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `lead_id` (`lead_id`);
...
--
-- AUTO_INCREMENT for table `tblleads_images`
--
ALTER TABLE `tblleads_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
