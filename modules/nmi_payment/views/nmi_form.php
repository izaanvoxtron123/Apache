        ...
        <div class="row">
            ...
            <div class="col-md-6 newnn">
                <div class="new_card">
                    ...
                    <div>
                        ...
                        <div class="card-box cards-placer">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control" name="cvv" id="cvv" maxlength="3" required placeholder="CVV" required>
                    ...
                    <div class="pay">
                        <button type="submit" id="submit_btn" disabled class="btn btn-primary">Pay</button>
                    </div>
                </div>
            ...
            <footer class="App-Footer Footer">
                <div class="">
                    <a class="Link Link--primary" href="https://maverickpayments.com/" target="_blank" rel="noopener">
                        <span class="Text Text-color--gray400 Text-fontSize--12 Text-fontWeight--400">
                            Powered by </span>
                        <img src="<?= base_url('modules/nmi_payment/assets/images/maverick.png') ?>">
                    </a>
            ...
            <!-- <footer class="App-Footer Footer">
                <div class="Footer-PoweredBy">
                    <a class="Link Link--primary" href="https://maverickpayments.com/" target="_blank" rel="noopener"><span class="Text Text-color--gray400 Text-fontSize--12 Text-fontWeight--400">Powered by </span><img src="<?= base_url('modules/nmi_payment/assets/images/maverick.png') ?>"></a>
                </div>
